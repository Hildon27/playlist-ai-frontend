          ...
          <div className="tracks-list">
            ...
            {loadingTracks && tracks.size === 0
              ...
              : playlist.musics.map((music, index) => {
                  ...
                  const albumCover =
                    music.albumCover || trackDetails?.albumCover;
                      ...
                      <div className="track-main">
                        <div className="track-cover-wrapper">
                          ...
                          {previewUrl && (
                            <button
                              ...
                              onClick={() =>
                                handlePreviewPlay(previewUrl, music.externalId)
                              }
                              title={
                        ...
                        <div className="track-info">
                          {trackName ? (
                            ...
                            <>
                              <span className="track-name track-loading">
                                Carregando...
                              </span>
                              <span className="track-artist track-id">
                                {music.externalId.slice(0, 12)}...
                              </span>
                            </>
                          )}
                        </div>
